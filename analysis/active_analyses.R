...
outcome_venn <- c(FALSE, FALSE, FALSE, FALSE)
...
df$prior_history_TRUE <- ifelse(df$outcome=="type 2 diabetes" ,FALSE,df$prior_history_TRUE)
df$prior_history_FALSE <- ifelse(df$outcome=="type 2 diabetes" ,FALSE,df$prior_history_FALSE)
